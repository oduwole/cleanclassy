...
'  '+
'    <style type="text/css">'+
'      table, td { color: #000000; } a { color: #5f5f8d; text-decoration: none; }'+
...
'      '+
'      <!--<img align="center" border="0" src="images/image-7.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 49%;max-width: 284.2px;" width="284.2"/>-->'+
'      '+
'    </td>'+
'  </tr>'+
'</table>'+
...
'    <div style="border-collapse: collapse;display: table;width: 100%;background-image: url(\'images/image-5.jpg\');background-repeat: no-repeat;background-position: center top;background-color: transparent;">'+
...
'    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong> Service Quotation </strong></span></p>'+
'<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 34px; line-height: 47.6px;"><strong>C L E A N \'N\' C L A S S Y</strong></span></p>'+
'  </div>'+
''+
'      </td>'+
'    </tr>'+
...
'    <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 20px">'+
'      <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">'+
'        <a href="https://api.whatsapp.com/send/?phone=23480517330803" title="WhatsApp" target="_blank">'+
